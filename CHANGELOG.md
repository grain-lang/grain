...
## [0.5.0](https://www.github.com/grain-lang/grain/compare/grain-v0.4.7...grain-v0.5.0) (2022-05-29)
...
* **compiler:** Add `[@unsafe](https://www.github.com/unsafe)` attribute for low-level code ([#1074](https://www.github.com/grain-lang/grain/issues/1074)) ([212faca](https://www.github.com/grain-lang/grain/commit/212faca9a8363002cfc0cb4e3ea293180cbe5b1c))
* **compiler:** Add warning for calls to IntXX.fromNumber and FloatXX.fromNumber with literal integers/floats ([#1218](https://www.github.com/grain-lang/grain/issues/1218)) ([2fb86e5](https://www.github.com/grain-lang/grain/commit/2fb86e538a9d38241d6c149cec1a290817795b4b))
* **compiler:** Allow function re-exports to use regular call instruction ([#1176](https://www.github.com/grain-lang/grain/issues/1176)) ([afce3aa](https://www.github.com/grain-lang/grain/commit/afce3aaa5382cde54b1e8fd9be3d2ee86daedbbb))
* **compiler:** Arbitrary-Precision Integer Arithmetic ([#1167](https://www.github.com/grain-lang/grain/issues/1167)) ([6f34de2](https://www.github.com/grain-lang/grain/commit/6f34de214b28358ea1df553685fa3a19336ddba9))
* **compiler:** Call known functions across module boundaries ([#1175](https://www.github.com/grain-lang/grain/issues/1175)) ([b2d7440](https://www.github.com/grain-lang/grain/commit/b2d744034ec7e0601554531c910e9d0f5451d464))
* **compiler:** Cleaner wasm output for low-level wasm types ([#1158](https://www.github.com/grain-lang/grain/issues/1158)) ([88060dd](https://www.github.com/grain-lang/grain/commit/88060ddb8119e2998d91f4d6770a1cfd101936cf))
...
* **compiler:** Convert `runtime/dataStructures.gr` to primitives ([#1145](https://www.github.com/grain-lang/grain/issues/1145)) ([2d43b28](https://www.github.com/grain-lang/grain/commit/2d43b286141df75f6b92300e48d2bc4804014872))
* **compiler:** Convert Sys libraries to [@unsafe](https://www.github.com/unsafe) ([#1272](https://www.github.com/grain-lang/grain/issues/1272)) ([fcdfc2a](https://www.github.com/grain-lang/grain/commit/fcdfc2a815be889d5f0424a04dd5b2373dbd983b))
* **compiler:** Don't close over global values ([#1134](https://www.github.com/grain-lang/grain/issues/1134)) ([e8caec6](https://www.github.com/grain-lang/grain/commit/e8caec6c2a5892e955c8827b18d8d436bebe6073))
* **compiler:** Name globals in wasm output ([#1184](https://www.github.com/grain-lang/grain/issues/1184)) ([51170e7](https://www.github.com/grain-lang/grain/commit/51170e7c892680f9c730b7f93cf744ffd6b7c15a))
...
* **compiler:** Reduce closure sizes by utilizing `$self` argument when possible ([#1152](https://www.github.com/grain-lang/grain/issues/1152)) ([ba6a84c](https://www.github.com/grain-lang/grain/commit/ba6a84cea191cf3c7932287c29b198001d490146))
* **compiler:** Refactor exports ([#1244](https://www.github.com/grain-lang/grain/issues/1244)) ([4637667](https://www.github.com/grain-lang/grain/commit/4637667cd669c0988cd01c2957534c6a35a3146c))
...
* **compiler:** Selectively include functions in the global function table ([#1183](https://www.github.com/grain-lang/grain/issues/1183)) ([67575f7](https://www.github.com/grain-lang/grain/commit/67575f712557bc36531f6e40044d1bbfff2454ff))
* **compiler:** Stack-allocated Chars ([#1103](https://www.github.com/grain-lang/grain/issues/1103)) ([095385e](https://www.github.com/grain-lang/grain/commit/095385e7c67bbc7a417a21acaf6f1c498c75ce63))
* **compiler:** Support pattern aliases ([#1174](https://www.github.com/grain-lang/grain/issues/1174)) ([9ed093b](https://www.github.com/grain-lang/grain/commit/9ed093be353895bdde8282ee1681089d5fac68ab))
* **compiler:** Support pattern matching "or" patterns ([#1173](https://www.github.com/grain-lang/grain/issues/1173)) ([0fb29c4](https://www.github.com/grain-lang/grain/commit/0fb29c4016e1b24b9e3b3b640cc9914b921ec376))
...
* **graindoc:** Allow directory input & output ([#1263](https://www.github.com/grain-lang/grain/issues/1263)) ([d4cb8ab](https://www.github.com/grain-lang/grain/commit/d4cb8abcb4accafeb3cae0bac77eee9a365e464d))
...
* **stdlib:** Add module for pseudo-random number generation ([#921](https://www.github.com/grain-lang/grain/issues/921)) ([db1fa4e](https://www.github.com/grain-lang/grain/commit/db1fa4e491d35bb582beaba12157884647384a77))
* **stdlib:** Add unsigned versions of Int32/Int64 comparison operations ([#831](https://www.github.com/grain-lang/grain/issues/831)) ([5f20868](https://www.github.com/grain-lang/grain/commit/5f20868e7b6e3f52d62c8531d99d1130ca84961e))
* **stdlib:** Added Bytes.clear function. Avoid allocation in Buffer.clear ([#1124](https://www.github.com/grain-lang/grain/issues/1124)) ([4afd17a](https://www.github.com/grain-lang/grain/commit/4afd17a91e59027fa7af0fe58977bdbe942f8072))
* **stdlib:** Convert runtime printing utils to [@unsafe](https://www.github.com/unsafe) ([#1135](https://www.github.com/grain-lang/grain/issues/1135)) ([403e1d2](https://www.github.com/grain-lang/grain/commit/403e1d20e2082fe2dcd2721f83f6c2b36d4154bf))
...
* **compiler:** Apply correct allocation type to numbers ([#1140](https://www.github.com/grain-lang/grain/issues/1140)) ([b9e9d59](https://www.github.com/grain-lang/grain/commit/b9e9d59143f529f7c0ae100b048988e6ba0e8d54))
* **compiler:** fix formatter multiple data bug ([#1282](https://www.github.com/grain-lang/grain/issues/1282)) ([f6fd962](https://www.github.com/grain-lang/grain/commit/f6fd96250dbe95d6b6c56d663f6d7f2704b792b3))
* **compiler:** Iterate over guard clauses in typedTreeIter/typedTreeMap ([#1283](https://www.github.com/grain-lang/grain/issues/1283)) ([96e8ecb](https://www.github.com/grain-lang/grain/commit/96e8ecb9e84e54d0640bc775e23e25b93c4dda7c))
* **compiler:** Move Filename usage to Filepath.String & normalize separators ([584bcad](https://www.github.com/grain-lang/grain/commit/584bcad942f91d86c9b328e61f34af6e3cfbd050))
* **compiler:** Preserve all configs when compiling ([#1207](https://www.github.com/grain-lang/grain/issues/1207)) ([d8ff903](https://www.github.com/grain-lang/grain/commit/d8ff9037fc3148384d2157f76e4394322ba4ed58))
* **compiler:** Read custom sections in full ([#1243](https://www.github.com/grain-lang/grain/issues/1243)) ([f8a0891](https://www.github.com/grain-lang/grain/commit/f8a0891f253e33153feb2ec20afe6443391a1aa8))
* **compiler:** Refactor WASI polyfill resolution ([#1261](https://www.github.com/grain-lang/grain/issues/1261)) ([a39b48f](https://www.github.com/grain-lang/grain/commit/a39b48ff95f4ef7ce5a4b5454dbc620ae4044c17))
* **compiler:** Report binop locations properly ([#1271](https://www.github.com/grain-lang/grain/issues/1271)) ([4b9dd9c](https://www.github.com/grain-lang/grain/commit/4b9dd9c35969cf86f1d2d9a8013b7f6d347c508e))
* **compiler:** Report Win32 instead of Cygwin in JS compiler ([#1251](https://www.github.com/grain-lang/grain/issues/1251)) ([584bcad](https://www.github.com/grain-lang/grain/commit/584bcad942f91d86c9b328e61f34af6e3cfbd050))
* **compiler:** Respect stack type when dropping statements ([#1138](https://www.github.com/grain-lang/grain/issues/1138)) ([5a44e93](https://www.github.com/grain-lang/grain/commit/5a44e93ab646f1e9998ce6c23245e41c4bf0019a))
* **compiler:** Supply correct error for unbound record labels ([#1200](https://www.github.com/grain-lang/grain/issues/1200)) ([86e1bc0](https://www.github.com/grain-lang/grain/commit/86e1bc0ba099c5b48ba72e98530a634e15f6bb77))
* **graindoc:** Avoid singletons when building ordered comments ([#1208](https://www.github.com/grain-lang/grain/issues/1208)) ([3f28e6e](https://www.github.com/grain-lang/grain/commit/3f28e6e226bbd951aedc6f8783203152919c7d08))
* **graindoc:** Fix type printing for types and abstract types ([#1238](https://www.github.com/grain-lang/grain/issues/1238)) ([aea3ea9](https://www.github.com/grain-lang/grain/commit/aea3ea9f6b72182dfffb8af4c9af83a444fb6a83))
* **graindoc:** Improve location lookup so re-exports do not crash it ([#1280](https://www.github.com/grain-lang/grain/issues/1280)) ([6e782ee](https://www.github.com/grain-lang/grain/commit/6e782ee146e16aefd3b88441de500d82a20508be))
...
* **graindoc:** Use value_descriptions and type_declarations defined by the module signature ([#1241](https://www.github.com/grain-lang/grain/issues/1241)) ([5896242](https://www.github.com/grain-lang/grain/commit/5896242c324622f3329c144bd2c9642aade9d049))
* **grainfmt:** Preserve the EOL characters of file ([#1216](https://www.github.com/grain-lang/grain/issues/1216)) ([ef2835a](https://www.github.com/grain-lang/grain/commit/ef2835a5608cb1d5de52b280b6d4fd5b563ce725))
* **grainfmt:** Properly handle if/then/else line breaks ([#1217](https://www.github.com/grain-lang/grain/issues/1217)) ([93fd3b5](https://www.github.com/grain-lang/grain/commit/93fd3b5d0a5ccbc11baaab08d0f65ff9ec98aead))
...
* **stdlib:** Add explicit void return type on Map.forEach ([#1220](https://www.github.com/grain-lang/grain/issues/1220)) ([ab2066a](https://www.github.com/grain-lang/grain/commit/ab2066aadffa8813344d9df7c7a10ec0f76751b6))
* **stdlib:** Add explicit void return type on Set.forEach ([#1225](https://www.github.com/grain-lang/grain/issues/1225)) ([694e6cf](https://www.github.com/grain-lang/grain/commit/694e6cf8fcd061a77b2915dc0ea9e9b1ae143ae4))
* **stdlib:** Align Buffer's `addStringSlice` API with String's `slice` ([#1136](https://www.github.com/grain-lang/grain/issues/1136)) ([0c7cb82](https://www.github.com/grain-lang/grain/commit/0c7cb820d49cda74598680cc614c0d893b4d2b40))
* **stdlib:** Buffer.toBytes should not expose the raw instance of Bytes used by the buffer ([#1130](https://www.github.com/grain-lang/grain/issues/1130)) ([d2bb585](https://www.github.com/grain-lang/grain/commit/d2bb585d3e2092f1331a679f4e84a9500b8c87a5))
* **stdlib:** Fix float printing in dtoa ([#1165](https://www.github.com/grain-lang/grain/issues/1165)) ([2987210](https://www.github.com/grain-lang/grain/commit/2987210648873ab474990ff2b7146a489fecb268))
...
* **compiler:** Add interface for compile module to hide resume ([d8ff903](https://www.github.com/grain-lang/grain/commit/d8ff9037fc3148384d2157f76e4394322ba4ed58))
* **compiler:** Disallow end-of-line before `=>` ([#1178](https://www.github.com/grain-lang/grain/issues/1178)) ([8261e73](https://www.github.com/grain-lang/grain/commit/8261e733c9345c690ffc107616512be4eb4c469e))
* **compiler:** Refactor HeapAllocated/StackAllocated into Managed/Unmanaged ([#1268](https://www.github.com/grain-lang/grain/issues/1268)) ([1590a37](https://www.github.com/grain-lang/grain/commit/1590a37ca39e39ee40e0f27986fe8195458c3cb9))
...
* **stdlib:** Add type aliases to regex lib ([#1036](https://www.github.com/grain-lang/grain/issues/1036)) ([a926ea5](https://www.github.com/grain-lang/grain/commit/a926ea5cafa18e46487a585abbdf5460b15b4f48))
