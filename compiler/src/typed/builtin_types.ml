...
and decl_box =
  ...
  decl_create
    { (decl_abstr path_box) with type_params = [ tvar ]; type_arity = 1 }

and decl_array =
  let tvar = newgenvar () in
  decl_create
    { (decl_abstr path_array) with type_params = [ tvar ]; type_arity = 1 }
