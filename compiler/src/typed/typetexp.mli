...
val transl_type_scheme : Env.t -> Parsetree.parsed_type -> Typedtree.core_type

val reset_type_variables : unit -> unit

val type_variable : Location.t -> string -> type_expr

val transl_type_param : Env.t -> Parsetree.parsed_type -> Typedtree.core_type
...
val transl_modtype_identifier :
  (* from Typemod *)
  (Location.t -> Env.t -> Identifier.t -> Path.t) ref

val find_type : Env.t -> Location.t -> Identifier.t -> Path.t * type_declaration
