...
and pretty_car ppf v = match v.pat_desc with _ -> pretty_val ppf v

and pretty_cdr ppf v = match v.pat_desc with _ -> pretty_val ppf v

and pretty_arg ppf v = match v.pat_desc with _ -> pretty_val ppf v
