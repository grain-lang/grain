...
and ident_wasmfuncref = ident_create("WasmFuncref")
and ident_wasmexternref = ident_create("WasmExternref")
...
and path_wasmfuncref = PIdent(ident_wasmfuncref)
and path_wasmexternref = PIdent(ident_wasmexternref)
...
and type_wasmfuncref = newgenty(TTyConstr(path_wasmf64, [], ref(TMemNil)))
and type_wasmexternref = newgenty(TTyConstr(path_wasmf64, [], ref(TMemNil)))
...
let initial_env = (add_type, empty_env) =>
  ...
  |> add_type(ident_wasmfuncref, decl_abstr_imm(WasmFuncref, path_wasmfuncref))
  |> add_type(ident_wasmexternref, decl_abstr_imm(WasmExternref, path_wasmexternref))
