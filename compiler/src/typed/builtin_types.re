...
and ident_wasmv128 = ident_create("WasmV128")
...
and path_wasmv128 = PIdent(ident_wasmv128)
...
and type_wasmv128 = newgenty(TTyConstr(path_wasmv128, [], ref(TMemNil)))
...
let initial_env = (add_type, add_extension, empty_env) =>
  ...
  |> add_type(ident_wasmv128, decl_abstr_imm(WasmV128, path_wasmv128))
