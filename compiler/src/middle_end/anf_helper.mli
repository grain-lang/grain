...
module Comp : sig
  ...
  val assign :
    ?loc:loc -> ?env:env -> imm_expression -> imm_expression -> comp_expression
  ...
  val while_ :
    ?loc:loc -> ?env:env -> anf_expression -> anf_expression -> comp_expression

  val switch :
    ?loc:loc ->
    ?env:env ->
    imm_expression ->
    (int * anf_expression) list ->
    comp_expression
  ...
  val lambda :
    ?loc:loc -> ?env:env -> ident list -> anf_expression -> comp_expression
