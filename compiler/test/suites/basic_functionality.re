...
describe("basic functionality", ({test}) => {
  ...
  assertRunError("assert3", "assert false", "AssertionError: Assertion failed in assert3, line 1");
  assertRunError("assert4", "assert 4 - 1 == 14", "AssertionError: Assertion failed in assert4, line 1");
  /* Failures */
