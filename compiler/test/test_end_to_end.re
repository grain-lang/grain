...
let basic_functionality_tests = [
  ...
  t("andshort1", "true && {print(1); false}", "1\nfalse"),
  t("andshort2", "false && {print(1); false}", "false"),
  t("andshadow", "let (&&) = (+); 1 && 2", "3"),
  t("or1", "true || true", "true"),
  t("or2", "true || false", "true"),
  t("or3", "false || true", "true"),
  t("or4", "false || false", "false"),
  t("orshort1", "true || {print(1); false}", "true"),
  t("orshort2", "false || {print(1); false}", "1\nfalse"),
  t("orshadow", "let (||) = (+); 1 || 2", "3"),
  t("land1", "1 & 1", "1"),
  t("land2", "1 & 0", "0"),
  t("land3", "0 & 1", "0"),
  t("land4", "0 & 0", "0"),
...
let loop_tests = [
  ...
  te("loop_err1", "break", "`break` statement used outside of a loop"),
  te("loop_err2", "continue", "`continue` statement used outside of a loop"),
  te(
    "loop_err3",
...
let string_tests = {
  ...
  [
    ...
    t("toString_escape1", {|("foo\\bar",)|}, {|("foo\\bar",)|}),
    t("toString_escape2", {|("foo\bbar",)|}, {|("foo\bbar",)|}),
    t("toString_escape3", {|("foo\fbar",)|}, {|("foo\fbar",)|}),
    t("toString_escape4", {|("foo\nbar",)|}, {|("foo\nbar",)|}),
    t("toString_escape5", {|("foo
bar",)|}, {|("foo\nbar",)|}),
    t("toString_escape6", {|("foo\rbar",)|}, {|("foo\rbar",)|}),
    t("toString_escape7", {|("foo\tbar",)|}, {|("foo\tbar",)|}),
    t("toString_escape8", {|("foo\vbar",)|}, {|("foo\vbar",)|}),
    t("toString_escape9", {|("foo\"bar",)|}, {|("foo\"bar",)|}),
...
let char_tests = [
  ...
  t("char_toString_escape1", {|('\\',)|}, {|('\\',)|}),
  t("char_toString_escape2", {|('\b',)|}, {|('\b',)|}),
  t("char_toString_escape3", {|('\f',)|}, {|('\f',)|}),
  t("char_toString_escape4", {|('\n',)|}, {|('\n',)|}),
  t("char_toString_escape5", {|('
',)|}, {|('\n',)|}),
  t("char_toString_escape6", {|('\r',)|}, {|('\r',)|}),
  t("char_toString_escape7", {|('\t',)|}, {|('\t',)|}),
  t("char_toString_escape8", {|('\v',)|}, {|('\v',)|}),
  t("char_toString_escape9", {|('\'',)|}, {|('\'',)|}),
  te(
    "char_illegal",
    "'abc'",
