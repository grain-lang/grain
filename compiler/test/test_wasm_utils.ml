...
let test_leb128_u32 ctxt =
  assert_equal_u32 ~ctxt (Uint32.of_int 624485)
    (read_leb128_u32 (iter_bytes [ 0xE5; 0x8E; 0x26 ]));
  assert_equal_bytes ~ctxt [ 0xE5; 0x8E; 0x26 ]
    (collect_bytes (fun sink -> write_leb128_u32 sink (Uint32.of_int 624485)))

let test_leb128_i32 ctxt =
  assert_equal_i32 ~ctxt (Int32.of_int (-624485))
    (read_leb128_i32 (iter_bytes [ 0x9B; 0xF1; 0x59 ]));
  assert_equal_bytes ~ctxt [ 0x9B; 0xF1; 0x59 ]
    (collect_bytes (fun sink -> write_leb128_i32 sink (Int32.of_int (-624485))))
